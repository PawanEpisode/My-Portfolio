...
export default function Timeline() {
  ...
  return (
    <div className="relative">
      <div className="absolute left-4 md:left-1/2 h-full w-0.5 bg-gradient-to-b from-indigo-500/50 via-fuchsia-500/50 to-transparent" />
      <ul className="space-y-10">
        {reverseItems.map((item, idx) => (
          <li key={idx} className="relative">
            ...
            >
              <div class="absolute inset-0 rounded-2xl bg-gradient-to-r from-green-400/40 to-blue-500/40 z-0"></div>
