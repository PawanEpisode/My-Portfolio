  ...
  return (
    <section className="border-t border-border px-4 py-12 min-[360px]:px-6">
      ...
      <div className="relative">
        <div className="absolute bottom-0 left-0 top-0 w-px bg-gradient-to-b from-accent-indigo via-accent-cyan to-accent-pink" />
        <div className="flex flex-col gap-6 pl-4">
          {items.map((item, idx) => (
            <motion.div
              ...
              className="relative"
            >
              <div className="absolute -left-4 top-[22px] h-3 w-3 -translate-x-1/2 rounded-full bg-gradient-to-br from-accent-indigo to-accent-cyan shadow-[0_0_8px_rgba(129,140,248,0.5)]" />
